...
import com.example.cryptocoach.presentation.components.PreferenceItem // Updated import
import com.example.cryptocoach.presentation.components.SelectionAlertDialog // Updated import
import com.example.cryptocoach.utils.TestTags // Assuming TestTags.kt was not moved

@Composable
fun SettingsScreen(viewModel: SettingsViewModel = hiltViewModel()) { // ViewModel from presentation.settings

    val currentTheme by viewModel.themePreference.collectAsStateWithLifecycle()
    val currentLanguage by viewModel.languagePreference.collectAsStateWithLifecycle()
    ...
    SelectionAlertDialog(
        ...
        onOptionSelected = {
            viewModel.saveThemePreference(it)
        },
